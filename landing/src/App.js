...
function App() {
    ...
    const icon_url = 'url(https://p7.hiclipart.com/preview/522/51/735/tony-tony-chopper-monkey-d-luffy-one-piece-treasure-cruise-chibi-chopper.jpg) center / cover';
    ...
    <div style={{height: '100vh', position: 'relative'}}>
        <Layout style={{background: back_url}}>
            ...
            <Content>
                ...
                <Main/>
                <Card shadow={1} style={{width: '50vh', margin: 'auto', marginTop: '20vh'}}>
                    <CardTitle style={{color: '#0099fg', height: '20vh', background: card_url}}>Bem vindo!</CardTitle>
                    <CardText>
                        Eai gaykkkkkk bora trabalhar
                    </CardText>
                    <CardActions border>
                        <Button colored>Ta in shockkkkkkk????</Button>
                    </CardActions>
